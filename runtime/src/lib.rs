...
parameter_types! {
	pub const TransactionByteFee: Balance = 1; // To do - update this value
}
...
impl pallet_transaction_payment::Config for Runtime {
	...
	type FeeMultiplierUpdate = (); // To do - setup this type
}
...
pub struct OriginTrailParachainGasWeightMapping;

impl pallet_evm::GasWeightMapping for OriginTrailParachainGasWeightMapping {
...
parameter_types! {
    pub const OriginTrailParachainTestnetId: u64 = 2160;
...
impl pallet_evm::Config for Runtime {
    ...
    type GasWeightMapping = OriginTrailParachainGasWeightMapping;
    ...
    type ChainId = OriginTrailParachainTestnetId;
...
parameter_types! {
	pub const CouncilMotionDuration: BlockNumber = 5 * MINUTES; // To do - Increase this in future
...
parameter_types! {
	...
	pub const SpendPeriod: BlockNumber = 5 * MINUTES; // To do - Increase this in future
